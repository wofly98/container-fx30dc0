...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fx30dc0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fx30dc0.containers.anotherwebservice.com/
...
```
git clone git@github.com:wofly98/container-fx30dc0.git
cd container-fx30dc0
```
...
```
docker attach container-fx30dc0
```
